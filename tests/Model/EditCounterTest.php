...
class EditCounterTest extends TestAdapter {
	...
	public function testLogCounts(): void {
		...
		static::assertSame( 0, $this->editCounter->getLogCounts()['delete-delete'] );
		static::assertSame( 0, $this->editCounter->countPagesDeleted() );
		static::assertSame( 1, $this->editCounter->countPagesMoved() );
		...
		static::assertSame( 0, $this->editCounter->countPagesProtected() );
		...
		static::assertSame( 0, $this->editCounter->countLogsDeleted() );
	...
	public function testPageCounts(): void {
		...
		static::assertSame( 1, $this->editCounter->countDeletedPagesEdited() );
	...
	public function testYearCounts(): void {
		...
		// Then more or less the same for yearCountsWithNamespaces:
	...
	public function testBlocks( array $blockLog, int $longestDuration, int $blockCount ): void {
		...
		// Check that by default we get no unblocks
