...
class AppExtensionTest extends TestAdapter {
	...
	public function testNumberFormat(): void {
		...
		static::assertSame( '50', $this->appExtension->numberFormat( 50.0000, 4 ) );
	}
	...
	public function testSizeFormat(): void {
		...
		static::assertSame( '100', $this->appExtension->sizeFormat( 100 ) );
		static::assertSame( '0', $this->appExtension->sizeFormat( 0 ) );
	...
	public function testRequestTime(): void {
		static::assertTrue( is_float( $this->appExtension->requestMemory() ) );
	}
